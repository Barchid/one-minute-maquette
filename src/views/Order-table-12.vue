<template>
  <div class="order-table-12">
    <h4 style="margin-bottom:30px;">Commande de la table 12</h4>
    ...
    <router-link to="/order-table-12"><button type="submit" class="btn btn-primary disabled" style="margin-bottom:30px;">Addition déjà réglée</button></router-link>
