<template>
  <div class="order-table-3">
    <h4 style="margin-bottom:30px;">Commande de la table 3</h4>
    ...
    <router-link to="/order-table-3"><button type="submit" class="btn btn-primary" style="margin-bottom:10px;margin-right:10px">Imprimer l'addition</button></router-link>
      ...
      <div class="row">
        <div class="col-l" style="margin-right:30px;">
          ...
          <form method="post" action="traitement.php">
            ...
            <p class="bg-warning" style="margin-bottom:0px" >
