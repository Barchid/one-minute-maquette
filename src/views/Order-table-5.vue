<template>
  <div class="order-table-14">
    <h4 style="margin-bottom:30px;">Commande de la table 14</h4>
    <div class="progress" style="margin-bottom:30px;">
      <div class="progress-bar progress-bar-striped bg-striped" role="progressbar" style="width: 30%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">Table à servir</div>
    </div>
    ...
    <router-link to="/order-table-5"><button type="submit" class="btn btn-primary" style="margin-bottom:10px;margin-right:10px">Imprimer l'addition</button></router-link>
