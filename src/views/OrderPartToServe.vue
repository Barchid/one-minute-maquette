<template>
  <div class="order-table-18">
    <h4 style="margin-bottom:30px;">Parties de commandes à servir</h4>
    ...
    <router-link to="/order"><button type="submit" class="btn btn-primary" style="margin-bottom:30px;">Valider les modifications</button></router-link>
        ...
        <div class="col-l" style="margin-right:30px;">
          ...
          <form method="post" action="traitement.php">
            ...
            <p style="margin-bottom:0px">
              ...
              <input type="button" value="-" style="color:white; background-color:red; border-color:white;margin:5px;height:30px;width:30px"/>
