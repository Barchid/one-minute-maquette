      ...
      <div class="row">
        <div class="col-l" style="margin-right:30px;">
          ...
          <form method="post" action="traitement.php">
            <h4 style="margin-top:30px;color:#007bff;text-align:center;">Menu Vegan</h4>
            ...
            <p style="margin-bottom:0px">
              ...
              <span style="font-weight: bold;color:#007bff">16€</span>
            ...
            <p style="margin-bottom:0px">
              ...
              <input type="button" class="bg-danger" value="-" style="color:white; cursor: pointer;  border:none; text-decoration: none;margin:5px;height:30px;width:30px"/>
              Lasagnes de légumes (vegan)<span style="font-weight: bold;color:#007bff">12€</span>
