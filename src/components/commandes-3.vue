        ...
        <div class="row">
          ...
          <div class="pagination-nav">
            <nav aria-label="Page navigation example">
              <ul class="pagination">
                <li class="page-item"><a class="page-link" href="commandes-2.html">Previous</a></li>
                ...
                <li class="page-item"><a class="page-link" href="commandes-1.html">Next</a></li>
              </ul>
            </nav>
          </div>
          <div class="col">
